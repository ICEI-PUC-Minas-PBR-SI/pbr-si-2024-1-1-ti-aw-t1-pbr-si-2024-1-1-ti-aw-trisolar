...
Serviços: Esta aba terá a função de alugar usinas solares de nossa empresa para os clientes interessados, o intuito de alugar as usinas, são para aqueles clientes que não possuem o investimento inicial necessário para comprar a própria. Assim o cliente dispõem de uma diminuição significativa em suas contas pagando uma taxa para nossa empresa por mês. Nós apenas disponibilizamos e gerenciamos os geradores, a entrega e instalação do produto será feita de forma terceirizada.

Calculadora: Esta aba terá a função do cliente consultar qual a quantidade de placas seriam necessárias para saciar/diminuir a energia consumida em sua casa, empresa, etc. 
...
Objetivos Chave: Não possui dinheiro para o investimento inicial dos produtos, por isso gostaria de ter a possibilidade de alugar geradores de energia fazendo um investimento inicial menor.
Como devemos tratá-lo: Ele gostaria de ter acessibilidade para comprar energia daqueles que têm interesse em vendê-la.
...
Como devemos tratá-lo: Comprou as placas já faz alguns anos, espera ver os lucros a medida do tempo. Ele gosta de sempre estar atualizado sobre o que vem acontecendo sobre seu investimento nas placas solares, gostaria de poder ver e controlar isso de alguma forma.
...
O site deve permitir que o usuário utilize a calculadora (insira, delete, subtraia, some e multiplique valores)
...
O site deve permitir que o usuário contrate o serviço de aluguel das usinas solares.
O site deve permitir que o usuário acesse seus dados de desempenho da contratação de aluguel.
...
Contém os arquivos no documento: "EtapadeDocumentação" no Repositório do GitHub
